        ...
        <div className='px-4 pt-96 pb-56 mx-auto md:px-6 lg:px-8'>
          <div className='flex items-center justify-between md:flex-row'>
            <div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12'>
              <span className='md:text-2xl xl:text-3xl italic text-shadow-md text-white'>
                &quot;{tagline}&quot;
              </span>
              ...
              <div className='my-4 flex items-center gap-4'>
                ...
                <Link href={`/movies/${id}`}>
                  <button className='border rounded text-cyan-400 border-cyan-300 py-2 px-5 hover:text-cyan-300 hover:neon-shadow duration-200'>
                    See Details
                  </button>
                </Link>
              </div>
